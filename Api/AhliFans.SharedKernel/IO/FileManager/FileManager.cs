...
namespace AhliFans.SharedKernel.IO.FileManager;

public interface IFileManager
{
  Task<bool> SaveFileAsync<T>(IFormFile file, string fileName, string path);
...
public class FileManager : IFileManager
{
  ...
  public async Task<bool> SaveFileAsync<T>(IFormFile file, string fileName, string path)
  {
    var _ = typeof(T).Name;
    try
    {
