using AhliFans.Core.Feature.Admin.Trophy.ChangeStatus.Events;
  ...
  .WithActionResult
{
  ...
  [SwaggerOperation(
    Summary = "Admin Change Status Trophy",
    Description = "Admin Delete/Retrieve Trophy",
    OperationId = "Admin.ChangeStatusTrophy",
  ...
  public override async Task<ActionResult> HandleAsync([FromQuery] ChangeTrophyStatusRequest request,
    ...
    await _mediator.Send(new ChangeTrophyStatusEvent(request.TrophyId), cancellationToken);
}
