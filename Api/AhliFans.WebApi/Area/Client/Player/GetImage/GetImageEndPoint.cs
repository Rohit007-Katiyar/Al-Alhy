using AhliFans.Core.Feature.Fan.Player.GetImage.Events;
  ...
  .WithActionResult
{
  ...
  [SwaggerOperation(
    Summary = "Client Get Player Image By His Id",
    Description = "Client Get Player Image By His Id",
    OperationId = "Client.GetPlayerImage",
